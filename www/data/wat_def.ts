...
export function WatGetCompletionItems(monaco: any) {
  ...
  return completionItems = [
    ...
    },
    {
      ...
      kind: keyword,
      insertText: { value: "param ${1:identifier} ${2:type}" },
    },
...
export function Wat(monaco: any) {
  return {
    MonarchDefinitions,
    LanguageConfiguration,
    CompletionItemProvider: {
      provideCompletionItems: function (_model: any, _position: any) {
        return WatGetCompletionItems(monaco);
      },
    },
    HoverProvider: {
